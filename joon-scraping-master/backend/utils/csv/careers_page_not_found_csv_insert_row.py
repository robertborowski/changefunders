...
# ------------------------ careers_page_not_found_csv_insert_row_function function start ------------------------
def careers_page_not_found_csv_insert_row_function(scrape_tracking_dict):
  localhost_print_function(' ------------------------ careers_page_not_found_csv_insert_row_function function start ------------------------ ')
  ...
  with open(r'backend/csv/output/careers_page_not_found.csv', 'a') as f:
    writer = csv.writer(f)
    writer.writerow(fields)
  localhost_print_function(' ------------------------ careers_page_not_found_csv_insert_row_function function end ------------------------ ')
  return True
# ------------------------ careers_page_not_found_csv_insert_row_function function end ------------------------


# ------------------------ call start ------------------------
# if __name__ == '__main__':
#   careers_page_not_found_csv_insert_row_function()
# ------------------------ call end ------------------------