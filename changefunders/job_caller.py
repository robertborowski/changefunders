...
from jobs.db_cleanup_jobs import job_clean_out_redis_function, job_remove_unsub_user_all_tables_function, job_list_all_redis_function
# ------------------------ imports end ------------------------
...
def job_caller_function():
  ...
  # ------------------------ remove users start ------------------------
  job_list_all_redis_function()
  # job_remove_unsub_user_all_tables_function(postgres_connection, postgres_cursor)
  # job_clean_out_redis_function(postgres_connection, postgres_cursor)
  # ------------------------ remove users end ------------------------
