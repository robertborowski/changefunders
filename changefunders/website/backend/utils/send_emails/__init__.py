...
localhost_print_function(' ------------------------ __init__ send_emails start ------------------------')
...
def send_email_template_function(output_email, output_subject_line, output_message_content):
  ...
  from_email = Email(email = os.environ.get('TRIVIAFY_NOTIFICATIONS_EMAIL'), name = "ChangeFunders")  # Change to your verified sender
...
localhost_print_function(' ------------------------ __init__ send_emails end ------------------------')